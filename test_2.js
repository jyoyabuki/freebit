        ...
        Object.defineProperties(this,{
            ...
            modes:{value:
                {
                    ...
                    function(){
                        var current = ref.__objects.betAmount.val();
                        var multiply = (current * 7).toFixed(8);
                        ref.__objects.betAmount.val(multiply);
                    },
                    }
                },
            ...
            showLogs: {value:
            	function(){
                    ...
                    console.log('%cWin: ' + this.total_wins + ' %cLost: ' + this.total_loses, 'color: #FFFF00', 'color: #FF0000');
                    console.log('%cHighest bet: ' + this.highest_win.toFixed(8) + ' %c' + this.highest_lose.toFixed(8), 'color: #FFFF00', 'color: #FF0000');
                    if(this.timeReached)
